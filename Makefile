...
.PHONY: all fmt lint build test-default test-bench test-short test-verbose test-race test-xml test test-coverage test-coverage-tools lint fmt deps-update image clean help
all: fmt lint build
