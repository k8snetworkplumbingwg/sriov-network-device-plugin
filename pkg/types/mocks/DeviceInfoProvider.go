...
type mockConstructorTestingTNewDeviceInfoProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDeviceInfoProvider(t mockConstructorTestingTNewDeviceInfoProvider) *DeviceInfoProvider {
