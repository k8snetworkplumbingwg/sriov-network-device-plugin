...
func (_m *DeviceProvider) GetFilteredDevices(_a0 []types.HostDevice, _a1 *types.ResourceConfig) ([]types.HostDevice, error) {
	...
	var r0 []types.HostDevice
	var r1 error
	if rf, ok := ret.Get(0).(func([]types.HostDevice, *types.ResourceConfig) ([]types.HostDevice, error)); ok {
		return rf(_a0, _a1)
	}
...
type mockConstructorTestingTNewDeviceProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDeviceProvider(t mockConstructorTestingTNewDeviceProvider) *DeviceProvider {
	mock := &DeviceProvider{}
	mock.Mock.Test(t)
