...
// MockNetDevice is an autogenerated mock type for the NetDevice type
type MockNetDevice struct {
	mock.Mock
}

// GetAPIDevice provides a mock function with no fields
func (_m *MockNetDevice) GetAPIDevice() *v1beta1.Device {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetDeviceCode() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetDeviceID() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetDeviceSpecs() []*v1beta1.DeviceSpec {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetDriver() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetEnvVal() map[string]types.AdditionalInfo {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetFuncID() int {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetLinkSpeed() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetLinkType() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetMounts() []*v1beta1.Mount {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetNetName() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetPfNetName() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetPfPciAddr() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) GetVendor() string {
	ret := _m.Called()
...
func (_m *MockNetDevice) IsRdma() bool {
	ret := _m.Called()
...
// NewMockNetDevice creates a new instance of MockNetDevice. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockNetDevice(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockNetDevice {
	mock := &MockNetDevice{}
