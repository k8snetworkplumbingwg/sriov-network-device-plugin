...
// MockPciDevice is an autogenerated mock type for the PciDevice type
type MockPciDevice struct {
	mock.Mock
}

// GetAPIDevice provides a mock function with no fields
func (_m *MockPciDevice) GetAPIDevice() *v1beta1.Device {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetAcpiIndex() string {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetDeviceCode() string {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetDeviceID() string {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetDeviceSpecs() []*v1beta1.DeviceSpec {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetDriver() string {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetEnvVal() map[string]types.AdditionalInfo {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetMounts() []*v1beta1.Mount {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetPciAddr() string {
	ret := _m.Called()
...
func (_m *MockPciDevice) GetVendor() string {
	ret := _m.Called()
...
// NewMockPciDevice creates a new instance of MockPciDevice. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockPciDevice(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockPciDevice {
	mock := &MockPciDevice{}
