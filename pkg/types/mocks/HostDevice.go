...
func (_m *HostDevice) GetAcpiIndex() string {
	ret := _m.Called()
...
type mockConstructorTestingTNewHostDevice interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewHostDevice(t mockConstructorTestingTNewHostDevice) *HostDevice {
	mock := &HostDevice{}
	mock.Mock.Test(t)
