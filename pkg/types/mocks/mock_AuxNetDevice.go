...
// MockAuxNetDevice is an autogenerated mock type for the AuxNetDevice type
type MockAuxNetDevice struct {
	mock.Mock
}

// GetAPIDevice provides a mock function with no fields
func (_m *MockAuxNetDevice) GetAPIDevice() *v1beta1.Device {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetAuxType() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetDeviceCode() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetDeviceID() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetDeviceSpecs() []*v1beta1.DeviceSpec {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetDriver() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetEnvVal() map[string]types.AdditionalInfo {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetFuncID() int {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetLinkSpeed() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetLinkType() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetMounts() []*v1beta1.Mount {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetNetName() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetPfNetName() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetPfPciAddr() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) GetVendor() string {
	ret := _m.Called()
...
func (_m *MockAuxNetDevice) IsRdma() bool {
	ret := _m.Called()
...
// NewMockAuxNetDevice creates a new instance of MockAuxNetDevice. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockAuxNetDevice(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockAuxNetDevice {
	mock := &MockAuxNetDevice{}
	mock.Mock.Test(t)
