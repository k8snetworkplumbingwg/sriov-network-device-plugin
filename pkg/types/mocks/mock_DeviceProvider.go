...
// MockDeviceProvider is an autogenerated mock type for the DeviceProvider type
type MockDeviceProvider struct {
	mock.Mock
}

// AddTargetDevices provides a mock function with given fields: _a0, _a1
func (_m *MockDeviceProvider) AddTargetDevices(_a0 []*pci.Device, _a1 int) error {
...
func (_m *MockDeviceProvider) GetDevices(_a0 *types.ResourceConfig, _a1 int) []types.HostDevice {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockDeviceProvider) GetDiscoveredDevices() []*pci.Device {
	ret := _m.Called()
...
func (_m *MockDeviceProvider) GetFilteredDevices(_a0 []types.HostDevice, _a1 *types.ResourceConfig, _a2 int) ([]types.HostDevice, error) {
...
func (_m *MockDeviceProvider) ValidConfig(_a0 *types.ResourceConfig) bool {
	ret := _m.Called(_a0)
...
// NewMockDeviceProvider creates a new instance of MockDeviceProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockDeviceProvider(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockDeviceProvider {
	mock := &MockDeviceProvider{}
	mock.Mock.Test(t)
