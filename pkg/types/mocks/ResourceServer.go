...
func (_m *ResourceServer) ListAndWatch(_a0 *v1beta1.Empty, _a1 grpc.ServerStreamingServer[v1beta1.ListAndWatchResponse]) error {
	ret := _m.Called(_a0, _a1)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*v1beta1.Empty, grpc.ServerStreamingServer[v1beta1.ListAndWatchResponse]) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
