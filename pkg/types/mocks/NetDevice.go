...
func (_m *NetDevice) GetAcpiIndex() string {
	ret := _m.Called()
...
type mockConstructorTestingTNewNetDevice interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewNetDevice(t mockConstructorTestingTNewNetDevice) *NetDevice {
	mock := &NetDevice{}
	mock.Mock.Test(t)
