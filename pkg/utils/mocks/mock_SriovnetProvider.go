...
// MockSriovnetProvider is an autogenerated mock type for the SriovnetProvider type
type MockSriovnetProvider struct {
	mock.Mock
}

// GetAuxNetDevicesFromPci provides a mock function with given fields: pciAddr
func (_m *MockSriovnetProvider) GetAuxNetDevicesFromPci(pciAddr string) ([]string, error) {
...
func (_m *MockSriovnetProvider) GetDefaultPKeyFromPci(pciAddr string) (string, error) {
	ret := _m.Called(pciAddr)
...
func (_m *MockSriovnetProvider) GetNetDevicesFromAux(auxDev string) ([]string, error) {
...
func (_m *MockSriovnetProvider) GetPfPciFromAux(auxDev string) (string, error) {
	ret := _m.Called(auxDev)
...
func (_m *MockSriovnetProvider) GetSfIndexByAuxDev(auxDev string) (int, error) {
	ret := _m.Called(auxDev)
...
func (_m *MockSriovnetProvider) GetUplinkRepresentor(vfPciAddress string) (string, error) {
...
func (_m *MockSriovnetProvider) GetUplinkRepresentorFromAux(auxDev string) (string, error) {
	ret := _m.Called(auxDev)
...
// NewMockSriovnetProvider creates a new instance of MockSriovnetProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockSriovnetProvider(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockSriovnetProvider {
	mock := &MockSriovnetProvider{}
	mock.Mock.Test(t)
