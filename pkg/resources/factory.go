...
import (
	...
	"github.com/intel/sriov-network-device-plugin/pkg/resources/rdma"
...
func (rf *resourceFactory) GetRdmaSpec(vendor, pciAddrs string) types.RdmaSpec {
	switch vendor {
	// Mellanox device
	case "15b3":
		return rdma.NewMlnxRdmaSpec(pciAddrs)
	default:
		return rdma.NewGenericRdmaSpec()
	}
}
